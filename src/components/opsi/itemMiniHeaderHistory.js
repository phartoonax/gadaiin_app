  ...
  return (
    ...
    >
      <div className="px-4 py-2 font-inter">
        ...
        <Stack
          className="pt-[10px] pb-1 text-neutral-100 text-sm font-normal items-center"
          direction="row"
        >
          <Icon
            fontSize={"16px"}
        ...
        <Stack
          className="pt-1 pb-[10px] text-neutral-100 text-base leading-[18px] font-normal items-center"
          direction="row"
        >
          <Icon
            fontSize={"16px"}
